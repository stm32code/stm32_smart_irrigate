...
#define GENERAL_TIM3_Period (1000 - 1) // 1ms一次中断
#define GENERAL_TIM3_Prescaler 71	   // 时钟预分频数

#define GENERAL_TIM4_Period (1000 - 1) // 1ms一次中断
#define GENERAL_TIM4_Prescaler 71	   // 时钟预分频数
